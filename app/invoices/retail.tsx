...
export default function RetailInvoice() {
  ...
  const searchCustomerInsideModal = async (text: string) => {
    setPhoneSearch(text);
  ...
  useEffect(() => {
    ...
    const ITEM_HEIGHT = 64; // ارتفاع صف الصنف تقريبي
    const OFFSET = 120; // يخليه في نص الشاشة

    const y = selectedIndex * ITEM_HEIGHT - OFFSET;
        ...
        <ScrollView style={{ flex: 1, backgroundColor: colors.background }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ color: colors.text }}>رقم الفاتورة</Text>
              ...
              <View style={{ position: "relative", marginBottom: 10 }}>
                <TextInput
                  ...
                  style={{
                    ...
                    borderColor: colors.border,
                    padding: 10,
                    paddingRight: 45, // مساحة للأيقونة
                    borderRadius: 8,
                    textAlign: "right",
                    borderWidth: 1,
                  }}
